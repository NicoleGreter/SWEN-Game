    ...
    def run(self):
        ...
        while running:
            ...
            for (
                ...
                if self.character.rect.colliderect(tile_rect):
                    if (
                        ...
                        self.character.x = (
                            tile_rect.left - self.character.character_width
                        )
                    elif (
                        self.character.rect.left
                        < tile_rect.right
                        ...
                        self.character.x = tile_rect.right
                    if (
                        ...
                        self.character.y = (
                            tile_rect.top - self.character.character_height
                        )
                    elif (
                        self.character.rect.top
                        < tile_rect.bottom
                        ...
                        self.character.y = tile_rect.bottom
